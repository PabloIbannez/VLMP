    ...
    {"author": "Pablo Ibáñez-Freire",
     ...
     "parameters":{
        ...
        "nSpikes":{"description":"Number of spike proteins to add to the vesicle surface.",
                   "type":"int",
                   "default":0},
        "epsilonLipids_kT":{"description":"Energy parameter for lipid-lipid interactions in kT units.",
                            "type":"float",
                            "default":5.0},
        ...
        "thetaLipids":{"description":"Angle parameter for lipid-lipid interactions.",
                       "type":"float",
                       "default":0.0},
        "epsilonLipidLipidWithProtein_kT":{"description":"Energy parameter for lipid-lipid interactions near proteins in kT units.",
                                           "type":"float",
                                           "default":5.0},
        "muLipidLipidWithProtein":{"description":"Shape parameter for lipid-lipid interactions near proteins.",
                                   "type":"float",
                                   "default":3.0},
        "chiLipidLipidWithProtein":{"description":"Another shape parameter for lipid-lipid interactions near proteins.",
                                    "type":"float",
                                    "default":7.0},
        "thetaLipidLipidWithProtein":{"description":"Angle parameter for lipid-lipid interactions near proteins.",
                                      "type":"float",
                                      "default":0.0},
        "epsilonLipidWithProtein_kT":{"description":"Energy parameter for lipid-protein interactions in kT units.",
                                      "type":"float",
                                      "default":5.0},
        "muLipidWithProtein":{"description":"Shape parameter for lipid-protein interactions.",
                              "type":"float",
                              "default":3.0},
        "chiLipidWithProtein":{"description":"Another shape parameter for lipid-protein interactions.",
                               "type":"float",
                               "default":7.0},
        "thetaLipidWithProtein":{"description":"Angle parameter for lipid-protein interactions.",
                                 "type":"float",
                                 "default":0.0},
        "proteinProteinEpsilon_kT":{"description":"Energy parameter for protein-protein interactions in kT units.",
                                    "type":"float",
                                    "default":1.0},
        "proteinLipidEpsilon_kT":{"description":"Energy parameter for protein-lipid interactions in kT units.",
                                  "type":"float",
                                  "default":1.0},
        "proteinSurfaceEpsilon_kT":{"description":"Energy parameter for protein-surface interactions in kT units.",
                                    "type":"float",
                                    "default":1.0},
        "proteinPeakSurfaceEpsilon_kT":{"description":"Energy parameter for peak protein-surface interactions in kT units.",
                                        "type":"float",
                                        "default":1.0},
        "peakProteins":{"description":"List of protein types considered as peak proteins.",
                        "type":"list of str",
                        "default":["S10"]},
        "lipidSurfaceEpsilon_kT":{"description":"Energy parameter for lipid-surface interactions in kT units.",
                                  "type":"float",
                                  "default":1.0},
